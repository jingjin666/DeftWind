...
#define AP_CAMERA_FEEDBACK_DEFAULT_FEEDBACK_PIN 118  // default is to not use camera feedback pin

#define AP_CAMERA_RELAY_DEFAULT_ON             0    // default Relay to trigger photo is low

#define AP_CAMERA_FEEDBACK_DEFAULT_POL         0    // default Feedback signal is low
