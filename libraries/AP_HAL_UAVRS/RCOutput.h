...
#define UAVRS_NUM_OUTPUT_CHANNELS 16


class UAVRS::RCOutput : public AP_HAL::RCOutput {
public:
    void     init() override;
...
private:
    ...
    int _alt_fd;
    uint16_t _freq_hz;
    uint16_t _period[UAVRS_NUM_OUTPUT_CHANNELS];
    ...
    uint16_t _last_sent[UAVRS_NUM_OUTPUT_CHANNELS];
