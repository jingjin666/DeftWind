...
#define IOMUX_ADIS_RESET       (IOMUX_PULL_NONE | IOMUX_CMOS_OUTPUT | \
                         IOMUX_DRIVE_40OHM | IOMUX_SPEED_MEDIUM | \
                         IOMUX_SLEW_SLOW)
#define GPIO_ADIS_RESET     (GPIO_PORT2 | GPIO_PIN30  | GPIO_OUTPUT | IOMUX_ADIS_RESET)
 ...
 * GPIO3_IO01
 */                         
#define GPIO_INS_PGOOD        (GPIO_INPUT | GPIO_PORT3 | GPIO_PIN23 | IOMUX_PGOOD)
 ...
 * GPIO3_IO04
 */
#define GPIO_P900_PGOOD        (GPIO_INPUT | GPIO_PORT3 | GPIO_PIN26 | IOMUX_PGOOD)
