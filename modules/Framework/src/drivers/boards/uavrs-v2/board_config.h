...
#define GPIO_LPSPI3_CS_ADIS16375BM  (GPIO_OUTPUT | GPIO_OUTPUT_ONE | GPIO_PORT3 | GPIO_PIN13 | IOMUX_LPSPI3_CS)//(GPIO_OUTPUT | GPIO_OUTPUT_ONE | GPIO_PORT1 | GPIO_PIN3 | IOMUX_LPSPI3_CS)
