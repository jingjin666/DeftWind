...
#define GPIO_CAMERA_TRIGGER_INPUT    /*P4:8 ALT5*/ (GPIO_PORT4 | GPIO_PIN8  | GPIO_INPUT | FMU_INPUT_IOMUX)
#define GPIO_CAMERA_TRIGGER_OUTPUT   /*P4:8 ALT5*/ (GPIO_PORT4 | GPIO_PIN8  | GPIO_OUTPUT | FMU_OUTPUT_IOMUX)

/* 3.3V Camer feedback signal */
#define GPIO_CAMERA_FEEDBACK_INPUT    /*P4:19  ALT5*/ (GPIO_PORT4 | GPIO_PIN19  | GPIO_INPUT | FMU_INPUT_IOMUX)
#define GPIO_CAMERA_FEEDBACK_OUTPUT   /*P4:19  ALT5*/ (GPIO_PORT4 | GPIO_PIN19  | GPIO_OUTPUT | FMU_OUTPUT_IOMUX)
