...
#ifndef __CONFIGS_IMXRT_USB_CDCACM_H
#define __CONFIGS_IMXRT_USB_CDCACM_H

#include "usb.h"
#include "usb_device_descriptor.h"
#include "usb_device_class.h"

#define CDCACM_DEVICE_PATH "/dev/ttyACM0"
#define CONTROLLER_ID kUSB_ControllerEhci0
#define DATA_BUFF_SIZE HS_CDC_VCOM_BULK_OUT_PACKET_SIZE //收发数据缓冲区长的为512
